...
// Export unified MongoDB connection functions for backwards compatibility
export const connectMongoDBPost = connectMongoDB;
export const connectMongoDBPhotos = connectMongoDB;
export const getPostsConnection = getMongoConnection;
export const getPhotosConnection = getMongoConnection;
